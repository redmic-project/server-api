...
@ActiveProfiles("test")
public class ProgramControllerTest extends IntegrationTestBase {
	...
	private final String PROGRAMS_URL_BASE = "/programs";
	...
	@Test
	public void deleteProgram_Return401_WhenUserIsAnonymous() throws Exception {

		this.mockMvc.perform(delete(PROGRAMS_URL_BASE + "/1")).andExpect(status().isUnauthorized());
	}

	@Test
	public void searchPrograms_Return200_WhenSearchIsCorrect() throws Exception {
		...
		this.mockMvc
				.perform(post(PROGRAMS_URL_BASE + "/_search").content(mapper.writeValueAsString(dataQuery))

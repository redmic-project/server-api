...
public class ContactMediaStorageControllerTest extends BaseMediaStorageControllerTest {

	@Value("${property.path.media_storage.CONTACTS}")
	private String PATH_CONTACTS;

	@Value("${controller.mapping.MEDIASTORAGE.UPLOADS_CONTACTS}")
	...
	public void uploadFile_Return200_IfUploadPhotoAsManagerUser() throws Exception {
		...
		checkResult(result, PATH_CONTACTS, URL_PHOTO_CONTACTS);
	}

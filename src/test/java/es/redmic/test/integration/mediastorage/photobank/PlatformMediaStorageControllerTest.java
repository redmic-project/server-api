...
public class PlatformMediaStorageControllerTest extends BaseMediaStorageControllerTest {

	@Value("${property.path.media_storage.PLATFORMS}")
	private String PATH_PLATFORMS;

	@Value("${controller.mapping.MEDIASTORAGE.UPLOADS_PLATFORMS}")
	...
	public void checkSecurity_Return200_IfUploadPhotoAsOAGUser() throws Exception {
		...
		checkResult(result, PATH_PLATFORMS, URL_PHOTO_PLATFORMS);
	}
